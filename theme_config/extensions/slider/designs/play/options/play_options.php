                ...
                array(
                    ...
                    'options' => array(
                        ...
                        array('name' => __('Subtitle', 'tfuse'),
                            ...
                            'type' => 'text',
                            'divider' => true),
                        array('name' => __('TAB Title', 'tfuse'),
                            'desc' => __('Tab Title', 'tfuse'),
                            'id' => 'slide_tab_title',
                            'value' => '',
                            'type' => 'text',
                            'divider' => true),
...
$options['extra_options'] = array(
    array('name' => __('Slide Subtitle', 'tfuse'),
        ...
        'value' => '',
        'type' => 'text'),
        array('name' => __('Slide Tab Title', 'tfuse'),
        'desc' => __('If the image from this post is gonna be fetched in one of the Sliders, the image needs to have a custom Tab Title in the slider. Please input one.', 'tfuse'),
