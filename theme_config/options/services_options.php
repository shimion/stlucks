...
$options = array(
    ...
    array('name' => __('Image', 'tfuse'),
        'desc' => __('Upload an image for your post, or specify an online address for your image (http://yoursite.com/image.png).', 'tfuse'),
    ...
    array('name' => __('Header Image', 'tfuse'),
        ...
        'value' => tfuse_options('service_header_image'),
        'type' => 'upload'
    )
);
