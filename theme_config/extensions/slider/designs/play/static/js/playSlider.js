...
(function ($) {
    $.fn.playSlider = function (options) {
        var defaults = {
            ...
            autoplaySpeed: tf_slider_interval.interval, // autoplay interval speed
            ...
            var slider = {
                init: function () {
                    ...
                    if(option.preloadImages){
                        ...
                        $t.append('<img src="' + tf_script.img_url + '/theme_config/extensions/slider/designs/play/static/images/loading.gif" class="prealoadImages" />');
                        item_img.hide();
