...
<?php
    ...
    add_action( 'wp_footer', create_function( '', 'wp_enqueue_script( "contactform" );' ) );
?>
...
<div class="contact-form">
    ...
    <form id="contactForm" action="" method="post" class="ajax_form" name="contactForm">
        ...
        <div class="row field_text alignleft">
            <label><?php _e('Your name (required)', 'tfuse') ?>:</label><br />
        ...
        <div class="row field_text alignleft omega">
            <label><?php _e('Your email (required)', 'tfuse') ?>:</label><br />
        ...
        <div class="row field_select alignleft">
            <label><?php _e('Category', 'tfuse') ?>:</label><br />
        ...
        <div class="row field_text alignleft omega">
            <label><?php _e('Subject', 'tfuse') ?>:</label><br />
            <input name="subject" value="" class="inputtext input_middle required" size="40" type="text" id="subject"/>
        </div>

        <div class="clear"></div>

        <div class="row field_textarea">
            <label><?php _e('Your Message', 'tfuse') ?>:</label><br />
        ...
        <div class="row">
            ...
            <input value="<?php _e('Submit message', 'tfuse') ?>" title="Submit message" class="btn-submit" id="send" type="submit" />
        </div>
